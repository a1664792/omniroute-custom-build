    ...
    () =>
      connections.filter(
        (conn) =>
          ...
          (conn.provider.startsWith("openai-compatible") || conn.provider.startsWith("anthropic-compatible") || USAGE_SUPPORTED_PROVIDERS.includes(conn.provider)) /* CONN_FILTER_TRAE_PATCH */ &&
